...
//                                 bool bLittleEndian, bool bInterleaved, bool bForSpeaker);
	...
	*/
    ...
    /**
     *  功能描述: 设置是否用耳机监听自己的声音或背景音乐，当不插耳机时，这个设置不起作用
    ...
    /**
     *  功能描述: 设置PCM数据回调对象
     *  @param  bSpeakerMute:true——输出至扬声器/听筒，false——不输出至扬声器/听筒，默认为true
     *  @return  None
     */
    YouMeErrorCode setPcmCallback(IYouMePcmCallback* pcmCallback, bool bOutputToSpeaker);
